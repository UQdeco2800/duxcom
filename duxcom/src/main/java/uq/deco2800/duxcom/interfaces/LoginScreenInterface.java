...
import uq.deco2800.duxcom.controllers.LoginScreenController;

/**
 * LoginScreenInterface implements an InterfaceSegment and is used to display the game's login
 * screen. The class is listed in the Enumeration InterfaceSegmentType as LOGIN_SCREEN.
 *
 * @author Alex McLean
 * @see InterfaceSegment
 * @see InterfaceSegmentType
 */
public class LoginScreenInterface implements InterfaceSegment {
    ...
    public boolean loadInterface(Stage primaryStage, String arguments, InterfaceManager interfaceManager) throws IOException {
        ...
        loginScreenController.setSingularityRestClient(ClientManager.getInstance().getRestClient());
